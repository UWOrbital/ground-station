...
from app.api.mcc.schemas.responses import PendingAdminRequestsResponse, UserInformationResponse
...
async def get_pending_admin_requests(mcc_users: MCCUsersRepo) -> PendingAdminRequestsResponse:
    """
